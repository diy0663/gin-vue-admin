<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="description字段" prop="description" width="120" />
        ...
        <el-table-column align="left" label="操作">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateCategoriesFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                <el-descriptions-item label="description字段">
...
const getTableData = async() => {
  const table = await getCategoriesList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
// 更新行
const updateCategoriesFunc = async(row) => {
...
// 删除行
const deleteCategoriesFunc = async (row) => {
